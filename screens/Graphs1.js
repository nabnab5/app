...
componentDidMount(){
  const myitems = firebase.database().ref('temperature');
  ...
  return(
        ...
        <View style={{alignItems: 'center',marginBottom: 70}}>
          ...
          <Text style={{color:'#045610',fontSize: 25,fontWeight: 'bold',marginTop: 10,opacity: 0.8}} >Temperature</Text>
        </View>
        <ScrollView horizontal={true}  >
                   ...
                   <View style={{
                       ...
                       />
                       <Button  color='transparent' fontWeight='bold' title="temperature" onPress={() => props.navigation.navigate('Graphs1')}/>
                   </View>
                   ...
                   <View style={{
                       ...
                       <Image
                        ...
                        style={{height:40,width:40}}
                       />
                      <Button  color='transparent' fontWeight='bold' title="Heartbeat" onPress={() => props.navigation.navigate('Graphs2')}/>
                   </View>
                   <View style={{
                       alignItems:"center",
                       backgroundColor:"#e5e4eb",
                       ...
                       <Image
                        ...
                        style={{height:40,width:40}}
                       />
                      <Button  color='transparent' fontWeight='bold' title="     weight   " onPress={() => props.navigation.navigate('Graphs3')}/>
                   </View>
                   <View style={{
                       alignItems:"center",
                       backgroundColor:"#e5e4eb",
                       ...
                       <Image
                        ...
                        style={{height:40,width:40}}
                       />
                      <Button  shadowcolor='#0000' color='transparent' fontWeight='bold' title="         Size         " onPress={() => props.navigation.navigate('Graphs4')}/>
                   </View>
                   </ScrollView>
