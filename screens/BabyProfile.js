...
const BabyProfile = (props) => {
  ...
  renderInner = () => (
    <View style={styles.panel}>
      ...
      <TouchableOpacity style={styles.panelButton} >
        <Button title='Update' color='transparent' fontWeight='bold'
         style={styles.panelButtonTitle}
         onPress={() => props.navigation.replace('Profile')}/>
      </TouchableOpacity>
      <TouchableOpacity style={styles.panelButton}>
        <Button title='Delete' color='transparent' fontWeight='bold'
         style={styles.panelButtonTitle}
  ...
  return (
    ...
    <BottomSheet
      ...
      <TouchableOpacity style={{left:300}} onPress={() => this.bs.current.snapTo(0)}>
        <Icon
          name='ios-settings'
          size={30}
          color='gray'
        ...
        />
         <Button  color='transparent' fontWeight='bold' title="     weight   " onPress={() => props.navigation.replace('Update')}/>
      </TouchableOpacity>
        <View style={{alignItems: 'center'}}>
